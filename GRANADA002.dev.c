...
#pragma config(Motor,  port5,           Motor_FW1,     tmotorVex393TurboSpeed_MC29, openLoop, encoderPort, dgtl1)
#pragma config(Motor,  port6,           Motor_FW2,     tmotorVex393TurboSpeed_MC29, openLoop, encoderPort, dgtl1)
...
task usercontrol()
{
	...
	while (true)
	{
		...
		//Descorer buttons
		if(vexRT[Btn7L] == 1|| vexRT[Btn6DXmtr2]==1){
			motor[Descorer] = -127;
			}else if(vexRT[Btn7U] == 1|| vexRT[Btn6UXmtr2]==1){
			motor[Descorer] = 127;
			}else{
			motor[Descorer] = 0;
		}
